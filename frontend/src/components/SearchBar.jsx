  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 bg-blue-600 text-white h-full p-1 font-bold text-xl hover:bg-blue-500">
          Search
        </button>
        <button className="w-1/3 bg-red-600 text-white h-full p-1 font-bold text-xl hover:bg-red-500">
          Clear
        </button>
      </div>
    </form>
